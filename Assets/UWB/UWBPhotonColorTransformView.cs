...
public class UWBPhotonColorTransformView : MonoBehaviour, IPunObservable
{
    ...
    public void Start()
    {
        ...
        syncColor = m_Renderer.material.color;
        Debug.Log("INITILIZE");
    }
    ...
    void Update()
    {
        ...
        {
            m_Renderer.material.color = syncColor;
            return;
        }
        ...
        if (this.m_PhotonView == null || PhotonNetwork.connected == false)
        {
            return;
        }
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        ...
        if (stream.isWriting)
        {
            tempColor = new Vector3(m_Renderer.material.color.r, m_Renderer.material.color.g, m_Renderer.material.color.b);
        ...
        else if (stream.isReading)
        {
            ...
            stream.Serialize(ref tempColor);
            syncColor = new Color(tempColor.x, tempColor.y, tempColor.z);
